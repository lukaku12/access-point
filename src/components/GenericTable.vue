  ...
  <div class="overflow-x-auto rounded-lg border border-gray-200/60 shadow-sm">
    ...
    <table class="min-w-full divide-y divide-gray-200/60 hidden md:table">
      ...
      <tbody class="bg-white divide-y divide-gray-200/60">
        ...
        <tr v-else>
          <td :colspan="actions?.length ? columns.length + 1 : columns.length" 
            ...
            <div class="flex flex-col items-center justify-center">
              ...
              <p class="mt-4 text-gray-500">{{ emptyMessage || 'No data available' }}</p>
            </div>
          </td>
        </tr>
      </tbody>
    ...
    <div class="md:hidden">
      ...
      <div class="divide-y divide-gray-200/60">
        ...
        <div v-else class="flex flex-col items-center justify-center py-12 bg-white">
          <div class="text-gray-400">
            <svg class="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" 
                d="M4 6h16M4 12h16M4 18h7" />
