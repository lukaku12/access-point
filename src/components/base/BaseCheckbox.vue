...
<template>
  <label class="flex items-center justify-between w-full" :class="{ 
    ...
    <div class="relative">
      ...
      <div
        ...
        :class="{
          'bg-blue-600 dark:bg-blue-500 border-blue-600 dark:border-blue-500 shadow-inner shadow-blue-700/25': modelValue && !disabled,
          'bg-gray-200 dark:bg-gray-700 border-gray-300 dark:border-gray-600': !modelValue && !disabled,
          'bg-gray-100 dark:bg-gray-800 border-gray-200 dark:border-gray-700': disabled
        }"
      ></div>
      <div
        class="dot absolute left-1 top-1 w-5 h-5 rounded-full transition-all duration-200 ease-in-out"
        :class="{
          'transform translate-x-7 bg-white dark:bg-gray-100 scale-95': modelValue && !disabled,
